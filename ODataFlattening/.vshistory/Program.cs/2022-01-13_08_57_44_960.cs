...
builder.Services.AddDbContext<FlatteningContext>(options => options.UseInMemoryDatabase("FlatteningDatabaseFlatteningContext"));
...
private async Task InitDbContext(WebApplication app)
{
